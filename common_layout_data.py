...
COMMON_LAYOUT_DATA: LayoutDictTypes = {
    ...
    'Face Restorer': {
        'FaceRestorerEnableToggle': {
            'level': 1,
            'label': 'Enable Output Enhancer 1',
            'default': False,
        ...
        'FaceRestorerEnable2Toggle': {
            'level': 1,
            'label': 'Enable Output Enhancer 2',
            'default': False,
            'help': 'Enable the use of a face restoration model to improve the quality of the face after swapping.'
        },
        ...
        'FaceExpressionEnableToggle': {
            'level': 1,
            'label': 'Enable Facial Expression Restorer',
            'default': False,
    ...
    'Full Body Swap': {
        'FullBodySwapEnableToggle': {
            'level': 1,
            'label': 'Enable Full Body Swap',
            'default': False,
            'show_reset_button': False,
            'help': 'Toggle on to enter your licence key and launch the Full Body Swap studio.',
        },
        'FullBodySwapApiKeyText': {
            'level': 2,
            'label': 'Licence Key',
            'default': '',
            'width': 200,
            'show_reset_button': False,
            'parentToggle': 'FullBodySwapEnableToggle',
            'requiredToggleValue': True,
            'help': 'Paste your MDF licence key, then click Open Studio.',
        },
    },
}